...
public class QuestLine {
    ...
    public QuestLine(Joueur j){
        ...
        quetes.add(new TalkQuete("Chapitre 1 - Je l'ai modifié", "Donc faites de même.\n Et si vous arrivez au bout, il faudra être le 1er à push le code pour obtenir le bonus ultime !!!!\n Serez vous de taille ?", 5, "Commit", 1, "vendeur"));
